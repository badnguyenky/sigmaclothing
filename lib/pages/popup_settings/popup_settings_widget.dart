...
import 'popup_settings_model.dart';
export 'popup_settings_model.dart';

class PopupSettingsWidget extends StatefulWidget {
  const PopupSettingsWidget({super.key});

  @override
  State<PopupSettingsWidget> createState() => _PopupSettingsWidgetState();
}
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: StreamBuilder<List<PopupRecord>>(
                            stream: queryPopupRecord(
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<PopupRecord> containerPopupRecordList =
                                  snapshot.data!;
                              final containerPopupRecord =
                                  containerPopupRecordList.isNotEmpty
                                      ? containerPopupRecordList.first
                                      : null;
                                                          ...
                                                          child: SizedBox(
                                                            ...
                                                            child:
                                                              ...
                                                              currentHTML:
                                                                  valueOrDefault<
                                                                      String>(
                                                                containerPopupRecord?.text !=
                                                                            null &&
                                                                        containerPopupRecord?.text !=
                                                                            ''
                                                                    ? containerPopupRecord
                                                                        ?.text
                                                                    : '<br>',
                                                                '<br>',
                                                              ),
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: FFButtonWidget(
                                                          onPressed: () async {
                                                            await containerPopupRecord!
                                                                .reference
                                                                .update(
                                                                    createPopupRecordData(
                                                              text: FFAppState()
                                                                  .textFromHtmlEditor,
                                                              status: _model
                                                                  .switchValue,
