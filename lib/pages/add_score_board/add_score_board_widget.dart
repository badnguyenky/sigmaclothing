                                                                              ...
                                                                              children: [
                                                                                ...
                                                                                FlutterFlowDropDown<String>(
                                                                                  controller: _model.dropDownValueController ??= FormFieldController<String>(
                                                                                    _model.dropDownValue ??= 'Above Score Or Good',
                                                                                  ),
                                                                                  options: const [
                                                                                    'Above Score Or Good',
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            '${valueOrDefault<String>(
                                                                              ((List<int> var1) {
                                                                                return var1.isNotEmpty ? var1.reduce((a, b) => a + b) : 0;
                                                                              }(containerJobsRecord.scores.map((e) => e.targetReached).toList()))
                                                                                  .toString(),
                                                                              '0',
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              child: Padding(
                                                                                padding: const EdgeInsetsDirectional.fromSTEB(10.0, 0.0, 0.0, 0.0),
                                                                                child: TextFormField(
                                                                                  controller: _model.txtCompletionTimeTextController ??= TextEditingController(
                                                                                  ...
                                                                                  focusNode: _model.txtCompletionTimeFocusNode,
                                                                                  autofocus: false,
                                                                                  readOnly: true,
                                                                                  obscureText: false,
                                                                                  decoration: const InputDecoration(
                                                                                  ...
                                                                                  validator: _model.txtCompletionTimeTextControllerValidator.asValidator(context),
                                                                                ),
                                                                              ),
                                                                            ),
                                                                            FlutterFlowIconButton(
                                                                              ...
                                                                              onPressed: () async {
                                                                                final datePicked2Time = await showTimePicker(
                                                                                  context: context,
                                                                                  initialTime: TimeOfDay.fromDateTime((containerJobsRecord.completionTime ?? DateTime.now())),
                                                                                  builder: (context, child) {
                                                                                    return wrapInMaterialTimePickerTheme(
                                                                                      context,
                                                                                      child!,
                                                                                ...
                                                                                safeSetState(() {
                                                                                  _model.txtCompletionTimeTextController?.text = dateTimeFormat("HH:mm", _model.datePicked2);
                                                                                  _model.txtCompletionTimeTextController?.selection = TextSelection.collapsed(offset: _model.txtCompletionTimeTextController!.text.length);
                                                                                });
                                                                              },
                                                                            ),
                                                                          ],
                                                                        ...
                                                                        children:
                                                                          ...
                                                                          Switch
                                                                            ...
                                                                            value: _model.switchValue ??=
                                                                                containerJobsRecord.completionStatus,
                                                                            onChanged:
                                                                                (newValue) async {
