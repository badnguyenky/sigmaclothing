...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/popupSettings',
          requireAuth: true,
          builder: (context, params) => const PopupSettingsWidget(),
        ),
        FFRoute(
          name: 'Cell',
          path: '/cell',
          requireAuth: true,
          builder: (context, params) => const CellWidget(),
        ),
        FFRoute(
          name: 'AssignJob',
          path: '/assignJob',
          requireAuth: true,
          builder: (context, params) => const AssignJobWidget(),
        ),
        FFRoute(
          name: 'AddCell',
          path: '/addCell',
          requireAuth: true,
          builder: (context, params) => const AddCellWidget(),
        ),
        FFRoute(
          name: 'ViewCell',
          path: '/viewCell',
          requireAuth: true,
          asyncParams: {
            'cell': getDoc(['cells'], CellsRecord.fromSnapshot),
          },
          builder: (context, params) => ViewCellWidget(
        ...
        FFRoute(
          ...
          builder: (context, params) => EditCellWidget(
            cell: params.getParam(
              'cell',
              ParamType.Document,
            ),
